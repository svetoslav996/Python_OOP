...
class IntegerListTest(TestCase):
    def test_is_initialized_correctly_without_data(self):
        integer = IntegerList()
        self.assertEqual([], integer.__IntegerList__data)
    ...
    def test_is_initialized_correctly_with_integers_data(self):
        ...
        self.assertEqual([5], integer.__IntegerList__data)
    ...
    def test_get_valid_index_retrun_element(self):
        integer = IntegerList(5)
    ...
    def test_insert_adds_element(self):
        ...
        integer.insert(0, 10)
        self.assertEqual([10, 5], integer.__IntegerList__data)
